...
otp_notification_text = '//android.widget.TextView[@resource-id="android:id/conversation_text" and @text="CP-AMIKKR"]'
otp_notification_message_text = '//android.widget.TextView[@resource-id="android:id/message_text"]'
matchcenter_button = '(//android.widget.TextView[@text="MATCHCENTRE"])[index]'
